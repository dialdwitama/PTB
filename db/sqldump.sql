...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2023 at 05:44 AM
...
--
-- Table structure for table `datapts`
--
...
--
-- Dumping data for table `datapts`
--

INSERT INTO `datapts` (`id_pts`, `kode`, `pt`) VALUES
...
--
-- Table structure for table `detail_lampiran`
--
...
--
-- Table structure for table `detail_ptb`
--

CREATE TABLE `detail_ptb` (
  `id_ptb` int(10) NOT NULL,
  `tgl_ptb` date NOT NULL,
...
--
-- Dumping data for table `detail_ptb`
--

INSERT INTO `detail_ptb` (`id_ptb`, `tgl_ptb`, `permintaan`, `kegiatan`, `hasil_keg`, `lampiran`, `ket`) VALUES
...
CREATE TABLE `monev` (
  ...
  `a_monev` varchar(100) DEFAULT NULL,
  `a_direk` varchar(100) DEFAULT NULL,
  `a_pddikti` varchar(100) DEFAULT NULL,
  `h_monev` varchar(100) DEFAULT NULL
...
INSERT INTO `monev` (`no`, `kode`, `pt`, `tglmonev`, `masalah`, `a_monev`, `a_direk`, `a_pddikti`, `h_monev`) VALUES
(17, 45060, 'Politeknik Maritim Eka Utama Subang', '2023-03-26', 'Sarana & Prasarana', 'Jl. Kapten Hanafiah No.45, Kel.Karanganyar, Kec.Subang, Kab.Subang, Jawa Barat', 'Kab. Subang - Jawa Barat', 'Kab. Subang - Prov. Jawa Barat - Indonesia', 'Ougheyyy!'),
(18, 43107, 'Sekolah Tinggi Teknologi Texmaco', '2023-03-08', 'Lahan Perpustakaan seluas 89 M2 (belum memenuhi)', 'Jalan Raya Cipeundeuy Pabuaran Km 3,5 Ds Karang Mukti Kec. Cipeundeuy Kab. Subang', 'Jalan Raya Cipeundeuy Pabuaran Km 3,5 Ds Karang Mukti Kec. Cipeundeuy Kab. Subang', 'Jalan Raya Pabuaran KM 3,5 Ds Karang Mukti Pabuaran, Kab. Subang, Jawa Barat', 'Sarana Prasarana, Akreditasi'),
(19, 44098, 'Akademi Sekretari dan Manajemen Insulindo', '2023-02-10', '1. Kuliah pada hari senin s/d jumat sore pukul 18.00 s/d 21.00, hari sabtu pukul 08.00 s/d 17.00 \r\n2. Yayasan tidak bisa menunjukan bukti kepemilikan lahan \r\n3. Prodi Manajemen Perusahaan 7 dosen berp', 'Grand Galaxy RSK 2 nomor 3-5 RT 2 RW XVII, Kec. Bekasi Selatan, Kota Bekasi, Jawa Barat', 'Jalan Cut Meutia Nomor 28 A', 'Jalan Ir. Juanda No. 240 Bekasi', 'Lokasi, Lahan Kampus');
...
INSERT INTO `pts` (`id_pts`, `kode`, `pt`, `progressTerakhir`, `tgl`, `deadline`, `stat`, `progressReport`, `pic`) VALUES
(13, '012365', 'TELKOM', 'BELUM NGUMPULIN PKS', '2023-03-02', '2023-03-30', '3', 'SECEPATNYA OK', 'LLDIKTI 4'),
(14, '12222', 'STIMIK AMIK', 'GPP', '2023-03-02', '2023-03-15', '3', 'YA', 'LLDIKTI 4'),
(15, '02139', 'UNIKOM', 'UKT NAEK', '2023-03-02', '2023-04-09', '5', 'DEMO G SI', 'LLDIKTI 4'),
(16, '', 'STTB', 'NgabuburIT', '2023-04-29', '2023-03-10', '4', 'Kill bill', 'LLDIKTI 4'),
(17, '3456', 'Sekolah Tinggi Teknologi Bandung', 'All of me', '2023-03-29', '2023-03-31', 'Menunggu Pelaporan', 'OK', 'LLDIKTI 4'),
(20, '21391', 'Universitas Siliwangi', 'Gedung Mandala', '2022-03-21', '2022-04-29', 'Menunggu Pelaporan', 'Gasken', 'LLDIKTI 4'),
(21, '02193', 'Universitas Singaperbangsa Karawang', 'Unsikuy', '2023-04-07', '2023-04-29', 'Sedang Ditindaklanjuti', 'Imagination', 'LLDIKTI 4'),
(22, '02319', 'STT Terpadu Nurul Fikri', 'Bogor hujan cuy', '2023-04-07', '2023-04-18', 'Sudah Kedaluwarsa', 'Hujan lur', 'LLDIKTI 4'),
(23, '92319', 'Institut Teknologi Harapan Bangsa', 'ITHB', '2023-04-13', '2023-03-17', '5', 'Melting', 'LLDIKTI 4'),
(26, '213412', 'STMIK Banten', 'Birokrasi', '2023-04-21', '2023-05-06', '5', 'Legalisasi', 'LLDIKTI 4'),
(27, '02391', 'Politeknik Negeri Bandung', 'Indonesia Raya', '2023-04-14', '2023-04-09', '3', 'Hiduplah Indonesia Raya', 'LLDIKTI 4'),
(28, '01291', 'STIE Maiji', 'Sambo', '2023-03-29', '2023-04-01', 'Menunggu Pelaporan', 'Sistem Informasi', 'LLDIKTI 4');
...
('admin', '21232f297a57a5a743894a0e4a801fc3', 'kl@gmail.com', 'LLDIKTI4 Kelembagaan', 1, 'LLDIKTI4');
...
--
-- Indexes for table `datapts`
--
ALTER TABLE `datapts`
  ADD PRIMARY KEY (`id_pts`);

--
-- Indexes for table `detail_lampiran`
--
ALTER TABLE `detail_lampiran`
  ADD PRIMARY KEY (`id_lampiran`);

--
-- Indexes for table `detail_ptb`
--
ALTER TABLE `detail_ptb`
  ADD PRIMARY KEY (`id_ptb`);
...
--
-- AUTO_INCREMENT for table `datapts`
--
ALTER TABLE `datapts`
  MODIFY `id_pts` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=446;

--
-- AUTO_INCREMENT for table `detail_lampiran`
--
ALTER TABLE `detail_lampiran`
  MODIFY `id_lampiran` int(100) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `detail_ptb`
--
ALTER TABLE `detail_ptb`
  MODIFY `id_ptb` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `pts`
  MODIFY `id_pts` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
COMMIT;
